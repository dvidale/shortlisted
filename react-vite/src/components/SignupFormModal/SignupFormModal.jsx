...
function SignupFormModal() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (firstName.length < 2)
      err.firstName = "First name must be at least two characters";
    if (lastName.length < 2)
      err.lastName = "Last name must be at least two characters";
    ...
    if (username.length < 6)
      err.username = "Username must be at least six characters";
    ...
    <>
      <div className="signup-modal-container">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <p className="two-line-error">{errors.confirmPassword}</p>
