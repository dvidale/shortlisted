...
function SearchResultsView({user, toggleSymbol, setToggleSymbol}){
    ...
    const { setLeftPanel, setCenterPanel } = useContext(PanelViews)
    ...
    // const avail_filtered_results = useAvailFilter({setIsLoading, searchResults, searchParams})
